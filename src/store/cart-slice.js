...
const cartSlice = createSlice({
  ...
  initialState: {
    items: [],
    totalQuantity: 0,
    totalPrice: 0, //len ako priklad, tu nie je
  },
  reducers: {
    addItemToCart(state, action) {
      ...
      state.totalQuantity++;
      if (!existingItem) {
        //normalny redux push nie je takto dovoleny...v redux/toolkit mozeme!
        state.items.push({
          id: newItem.id,
          price: newItem.price,
          quantity: 1,
...
export const sendCartData = (cart) => {
  ...
  //je to strasne zamotany lekcia 259....Using Action Creator Thunk!!
